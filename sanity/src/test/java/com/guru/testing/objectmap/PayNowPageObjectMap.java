...
public enum PayNowPageObjectMap {
	...
	PAY_NOW_PAGE_PAY_WITH_CREDIT_CARD_BUTTON_XPATH("//label[@class='module_btn secondary_btn lonely_btn switch-input-label']"),
	PAY_NOW_PAGE_PAY_WITH_CREDIT_CARD_NUMBER_TEXTBOX_XPATH("(//input[@class='niceInput ng-pristine ng-valid ng-valid-pattern'])[1]"),
	PAY_NOW_PAGE_PAY_WITH_CREDIT_CARD_EXP_MONTH_DROPDOWN_XPATH("//select[@class='niceInput hasDefault ng-pristine ng-valid']"),
	PAY_NOW_PAGE_PAY_WITH_CREDIT_CARD_EXP_YEAR_DROPDOWN_XPATH("//select[@class='niceInput auto hasDefault ng-pristine ng-valid']"),
	PAY_NOW_PAGE_PAY_WITH_CREDIT_CARD_CVV_TEXTBOX_XPATH("//input[@class='niceInput auto ng-pristine ng-valid ng-valid-pattern'][@placeholder='CVV']"),
