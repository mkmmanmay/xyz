...
public enum JobDetailsPageObjectMap {
	...
	JOB_DETAILS_PAGE_ASK_QUESTION_TEXT_AREA_NOT_FOCUSED_XPATH("//div[@class='projMsg-respond']"),
	JOB_DETAILS_PAGE_ASK_QUESTION_TEXT_AREA_FOCUSED_XPATH("//div[@class='projMsg-respond focused']"),
	JOB_DETAILS_PAGE_ASK_QUESTION_TEXT_AREA_ID("reply"),
	JOB_DETAILS_PAGE_ASK_QUESTION_BUTTON_DISABLED_XPATH("//button[@ng-click='PostMessage()'][@disabled='disabled']"),
	JOB_DETAILS_PAGE_ASK_QUESTION_BUTTON_ENABLED_XPATH("//button[@ng-click='PostMessage()']"),
	JOB_DETAILS_PAGE_ASK_QUESTION_MESSAGE_THREAD_XPATH("//div[@id='divMessage']//ul[@id='messages-thread']//pre[@class='projMsg-thread-message ng-binding']"),
	JOB_DETAILS_PAGE_ASK_QUESTION_DELETE_ICON_XPATH("//a[@ng-click='msgDiscard()']"),
