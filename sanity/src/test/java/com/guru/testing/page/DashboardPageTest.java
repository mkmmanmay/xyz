...
public class DashboardPageTest {
	...
	public static void verifyFLDashboardPageTest() throws Exception {
		...
		try {
			...
			throw new HTMLElementNotFoundException(e,"Unable to find Freelancers Dashboard page");
		}
	}
	...
	public static void verifyEMPDashboardPageTest() throws Exception {		
		...
		try {
			...
			throw new HTMLElementNotFoundException(e, "Unable to find Employer Dashboard page");
		}
	}
