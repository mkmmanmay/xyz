...
public class WorkroomPageTest {
	...
	// ------------------------  START  -------------------------------
	@Test
	@Documentation(step = "Click on 'Attach Files'.", expected = "User is able to click.")
	public static void clickAttachFilesTest() throws Exception {
		...
		try {
			...
			throw new HTMLElementNotFoundException(e, "Unable to click.");
		}
	}
	...
	public static void setLastDateInPopupTest() throws Exception {
		...
		try {
			...
			throw new ScriptException("Couldn't set field values; possible selenium or locator or script logic issue.");
		}
	}
	...
	public static void clickAddMyTeamOnChatTest() throws Exception {
		ScriptLogger.info();	
		try {
		} catch (Exception e) {
	...
	public static void verifyTeamMemberAddedTest() throws Exception {
		ScriptLogger.info();	
		try {
		} catch (Exception e) {
	...
	@Test
	@Documentation(step = "", expected = "")
	public static void verifyChatRoomCreatedTest() throws Exception {
		ScriptLogger.info();	
		try {
		} catch (Exception e) {
	...
	@Test
	@Documentation(step = "", expected = "")
	public static void verifyRandomChatMessageTest() throws Exception {
		ScriptLogger.info();	
		try {
		} catch (Exception e) {
