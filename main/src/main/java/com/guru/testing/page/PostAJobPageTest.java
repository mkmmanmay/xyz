...
public class PostAJobPageTest {
	public static String RANDOM_TOKEN="hntrv";
	...
	@Documentation(step = "Verify Post a Job Page", expected = "Verification should be successful.")
  	public static void verifyPostAJobPageTest() throws Exception {
		...
		try {
			...
			throw new HTMLElementNotFoundException(e,"Elements Required to verify Posy a Job page didnot load .");
		}
		try {
	...
	public static void enterJobTitleTest(String jobTitle) throws Exception {
		try {
			...
			throw new ApplicationException("Couldn't enter data in the field, or invalid inputs were entered. Cross-verify.");
		}
	}
	...
	private static void checkIfEnteredDetailsAreValid() throws Exception {
		...
		try {
			...
			throw new ApplicationException("Possible that entered data is invalid.");
		}
	}
