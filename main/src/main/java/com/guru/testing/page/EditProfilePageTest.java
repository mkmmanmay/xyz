...
public class EditProfilePageTest {
	...
	public static void verifyEditProfileTest() throws Exception {
		...
		try {
			...
			try {
				...
				throw new HTMLElementNotFoundException(e2, "Required elements to Verify Edit profile page didnot load .");
			}
	...
	@Test
	@Documentation(step = "Click on Profile Pic", expected = "Profile Pic clicked")
	...
	@Test
	@Documentation(step = "Click on View Profile link ", expected = "Ciew profile link clicked")
