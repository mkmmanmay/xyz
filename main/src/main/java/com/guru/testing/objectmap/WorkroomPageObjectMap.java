...
public enum WorkroomPageObjectMap {
	...
	WORKROOM_PAGE_AGREEMENT_TAB_HOURLY_BILLING_END_DATE_POP_UP_LAST_DATE_XPATH("//div[contains(@class, 'datePickerPopUp')]//table//tbody//tr[6]//td[8]"),
	...
	WORKROOM_PAGE_JOB_SEND_MESSAGE_BUTTON_XPATH("//button[contains(@class, 'module_btn primary_btn ng-binding')]"),
	...
	// -------------- MY TEAM TAB FL --------------------
	WORKROOM_PAGE_MY_TEAM_TAB_BUILD_MY_TEAM_BUTTON_XPATH("//input[@value='Build My Team']"),
	WORKROOM_PAGE_MY_TEAM_TAB_LEAVE_THIS_TEAM_LINK_XPATH("//span[contains(text(), 'Leave This Team')]"),
	WORKROOM_PAGE_MY_TEAM_TAB_MEMBER_ICONS_XPATH("//section[@id='members']//ul[@class='clearfix grid_list grid4x']//li"),
			// --------------- INVITE TEAM MEMBERS --------------
	WORKROOM_PAGE_INVITE_TEAM_MEMBERS_INVITE_FORM_SECTION_XPATH("//div[@class='emailList ']"),
	WORKROOM_PAGE_INVITE_TEAM_MEMBERS_INVITE_FORM_ROWS_XPATH("//div[@class='emailList ']//div[contains(@id, 'flTeam')]"),
	WORKROOM_PAGE_INVITE_TEAM_MEMBERS_ADD_TEAM_MEMBER_BUTTON_XPATH("//input[@value=' Add Team Member']"),
	WORKROOM_PAGE_INVITE_TEAM_MEMBERS_ADD_ANOTHER_PERSON_PLINK("Add another person"),
	WORKROOM_PAGE_INVITE_TEAM_MEMBERS_CANCEL_BUTTON_XPATH("//input[@value='Cancel']"),
