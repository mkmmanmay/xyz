...
public enum PayNowPageObjectMap {
	...
	PAY_NOW_PAGE_PAY_BUTTON_DISABLED_XPATH("//button[contains(@class, 'module_btn primary_btn payBtn')][@disabled='disabled']"),
	PAY_NOW_PAGE_PAY_BUTTON_ENABLED_XPATH("//button[contains(@class, 'module_btn primary_btn payBtn')]"),
