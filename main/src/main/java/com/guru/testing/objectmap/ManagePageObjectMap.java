...
public enum ManagePageObjectMap {
	...
	MANAGE_PAGE_ADD_A_MANAGER_IN_JOB_PAGE_ADD_BUTTON_XPATH("//input[@value=' Add ']"),
	...
	MANAGE_PAGE_ADD_A_MANAGER_IN_JOB_PAGE_MY_TEAM_PAGE_BUILD_MY_TEAM_BUTTON_XPATH("//input[@value='Build My Team']"),
	...
	MANAGE_PAGE_ADD_A_MANAGER_IN_JOB_PAGE_MY_TEAM_PAGE_MEMBER_NAME_XPATH("//span[@class='memberName']"),
	...
	MANAGE_PAGE_MY_MANAGERS_SUB_TAB_MEMBER_TILES_TEXT_XPATH("//div[@class='teamPage clearfix']//li[contains(@id, 'li')][contains(@class, 'member')]"),
	...
	MANAGE_PAGE_FL_ADD_TEAM_MEMBER_BUTTON_ID("Invite"),
	;
